...
import { logoImageUrl, logoName1, logoName2, navMenu, hamburgerClick, isLoggedIn, navIcon, footerLink1, footerLink2, openHours, socialMedia, backToTop, yearCopyright } from "../helpers/const";
