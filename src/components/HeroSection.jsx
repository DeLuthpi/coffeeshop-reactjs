...
const HeroSection = (props) => {
	return (
		...
		<section className="hero-section" aria-labelledby="hero-section">
			<img className="hero-banner-img" src={props?.heroBgImage} alt="hero-bg-image" />
			<div className="hero-banner">
				<div className="container banner-layout">
					<div className="banner-layout-text">
						<p className="banner-text-p1">Welcome to {props?.logoName1} {props?.logoName2}. . .</p>
			...
			<div className="hero-banner-svg">
				<svg viewBox="0 0 1428 174" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
					<g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
						...
						<g transform="translate(-4.000000, 76.000000)" fill="#fefae0" fillRule="nonzero">
